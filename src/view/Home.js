...
const Home = () => {
  return (
    <>
     ...
     <div style={{marginTop:"1px",marginLeft:"32rem",display:"flex",textAlign:"center"}}>
     <Form.Item className="button" >
       <a href="/Getstarted"> <Button style={{background:"rgb(2, 12, 68)", color:"white",textAlign: "center",margin:"0 auto",marginLeft:"1rem",borderRadius:"2rem",width:"20rem",marginTop:"90px"}}>Individual<br></br><br></br><h4 style={{color:"white"}}>(for myself)</h4></Button></a>
      </Form.Item>
      <Form.Item >
      <a href="/Getstarted"> <Button style={{background:"rgb(2, 12, 68)",color:"white",textAlign: "center",marginLeft:"1rem",borderRadius:"2rem",marginTop:"90px"}}>Couple<br></br><br></br><h4 style={{color:"white"}}>(for me and my parterner)</h4></Button></a>
      </Form.Item>
      <Form.Item >
      <a href="/Getstarted"> <Button style={{background:"rgb(2, 12, 68)",color:"white",textAlign: "center",marginLeft:"1rem",borderRadius:"2rem",width:"20rem",marginTop:"90px"}}>Children<br></br><br></br><h4 style={{color:"white"}}>(for my child)</h4></Button></a>
      </Form.Item>
      </div>
      </div>
      ...
      <div className="hne"> 
       ...
       <a href="/asktherapist"><Button style={{background:"rgb(2, 12, 68)",color:"white",borderRadius:"10rem",marginLeft:"0px"}}>Get matched to a therapist</Button></a> 
          ...
          <div className="ther">
          <img src="https://dy7glz37jgl0b.cloudfront.net/home/betterhelp/full-schedule.png?v=966d54b722cb" alt="" style={{marginLeft:"10px"}}></img>
          
          
          <img src="https://dy7glz37jgl0b.cloudfront.net/home/betterhelp/full-session.png?v=966d54b722cb" alt="" style={{marginLeft:"350px"}}></img>  
        </div>
